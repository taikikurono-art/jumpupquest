...
// ======== JOB DATA ========
const JOBS={
  rookie:     {name:'ルーキー',       charName:'シバッチ', genre:'入門',          emoji:'🐕', color:'#ffb7a0', tier:'入門',  desc:'体操の世界に踏み出したばかりの冒険者！まずは基本の動きをしっかり覚えよう。'},
  challenger: {name:'チャレンジャー',  charName:'グラン',   genre:'初級',          emoji:'🐻', color:'#ffe066', tier:'初級',  desc:'基本をマスターした挑戦者。ここから6つのジョブへ進化できるぞ！'},
  ninja:      {name:'ニンジャ',        charName:'クロウド', genre:'反射',          emoji:'🦊', color:'#bb33ff', tier:'中級', desc:'素早い反射神経と瞬発力を持つ忍者。瞬間的な動きの切れ味が武器！'},
  airrider:   {name:'エア・ライダー',  charName:'ライト',   genre:'跳躍',          emoji:'🐰', color:'#00ccee', tier:'中級', desc:'軽やかに空を舞う跳躍の達人。高さとスピードで誰よりも高く飛び上がれ！'},
  coremaster: {name:'コア・マスター',  charName:'ゼン',     genre:'バランス',       emoji:'🐱', color:'#33cc55', tier:'中級', desc:'体幹の強さとバランス感覚に優れた達人。倒立や静止技が完璧に決まる！'},
  performer:  {name:'パフォーマー',    charName:'エレナ',   genre:'美しさ',         emoji:'🦢', color:'#ff7722', tier:'中級', desc:'美しい動きと表現力を持つアーティスト。ポーズや演技の美しさで観客を魅了する！'},
  waterflow:  {name:'ウォーター・フロー',charName:'リュウ', genre:'柔軟',         emoji:'🦦', color:'#6655ff', tier:'中級', desc:'水のように柔らかく流れる動きが特技。しなやかさと流れる美しさが武器！'},
  striker:    {name:'ストライカー',    charName:'ボルト',   genre:'パワー',         emoji:'🦍', color:'#ff3333', tier:'中級', desc:'力強いジャンプと爆発的なパワーを持つ戦士。空中技や高さのある技が得意！'},
  tracerunner:{name:'トレース・ランナー',charName:'ソウ',  genre:'パルクール',   emoji:'🐒', color:'#ff5588', tier:'上級',  desc:'反射×バランスを極めた者がなれる超高速の体術師！壁も障害物も自由自在に駆け抜けろ。'},
  airmaster:  {name:'エアマスター',    charName:'ファルコ', genre:'アクロバット',   emoji:'🦅', color:'#00ffaa', tier:'上級',  desc:'パワー×跳躍を極めた者だけがなれる究極の空中術師！宙返りや高難度技をマスターしている。'},
  illusionist:{name:'イリュージョニスト',charName:'ミラ',  genre:'新体操',       emoji:'🐿️', color:'#ff88dd', tier:'上級',  desc:'美しさ×柔軟を極めた者だけがなれる美の頂点。新体操の芸術で観客を魅了する伝説の演者。'},
  next:       {name:'NEXT ?',          charName:'？',       genre:'Coming Soon',   emoji:'❓', color:'#555577', tier:'???',   desc:'次のジョブはまだ秘密…。さらなる高みを目指す冒険者に新しいジョブが解放されるかも！？'},
};
